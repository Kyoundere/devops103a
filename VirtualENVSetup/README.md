...
- orchestration
- push config - ansible push to config 
- terraform for ochestration
- ansible YAML/YML file.yml/yaml

- playbook: advanced form of shell script

learned ansible on site
can create same infrastructure on cloud in the work environment, just need to change some of the things, still able to use the work that we did previously and rerun it on there
